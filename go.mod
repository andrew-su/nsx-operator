...
require (
	github-vcf.devops.broadcom.net/vcf/kubernetes-service v0.0.0-20260122102357-d8495dc28789
	...
	github.com/vmware-tanzu/nsx-operator/pkg/apis v0.0.0-20251215055625-d51f550d4623
